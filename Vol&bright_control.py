...
from pycaw.pycaw import AudioUtilites, IAudioEndpointCVolume
...
try:
    dev = AudioUtilites.GetDefaultOutputDevice() if hasattr(AudioUtilites, "GetDefaultOutputDevice") else AudioUtilites.GetSpeakers()
    volctl = dev.EndpointVolume.QueryInterface(IAudioEndpointCVolume)
...
while True:
    ...
    if res.multi_hand_landmarks and res.multi_handedness:
        for i, hand in enumerate(res.multi_landmarks):
